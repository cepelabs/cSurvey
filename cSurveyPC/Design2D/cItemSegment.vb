...
Namespace cSurvey.Design.Items
    Public Class cItemSegment
        ...
        'Public Function GetProfileSplayBorderLineStyle() As cIItemProfileSplayBorder.SplayBorderLineStyleEnum Implements cIItemProfileSplayBorder.GetSplayBorderLineStyle
        '    Return oSegment.GetProfileSplayBorderLineStyle
        'End Function

        'Public Property ProfileSplayBorderLineStyle As cIItemProfileSplayBorder.SplayBorderLineStyleEnum Implements cIItemProfileSplayBorder.SplayBorderLineStyle
        '    Get
        '        Return oSegment.ProfileSplayBorderLineStyle
        '    End Get
        '    Set(value As cIItemProfileSplayBorder.SplayBorderLineStyleEnum)
        '        If oSegment.ProfileSplayBorderLineStyle <> value Then
        '            oSegment.ProfileSplayBorderLineStyle = value
        '            Call MyBase.Caches.Invalidate()
        '        End If
        '    End Set
        'End Property
