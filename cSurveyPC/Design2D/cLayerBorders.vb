    ...
    Public Class cLayerBorders
        ...
        Friend Overrides Sub Paint(ByVal Graphics As Graphics, ByVal PaintOptions As cOptions, ByVal Options As cItem.PaintOptionsEnum, ByVal Clipping As cClippingRegions, ByVal CurrentCave As String, ByVal CurrentBranch As String)
            ...
            For Each oItem As cItem In MyBase.Items
                ...
                End If
            Next
            Call MyBase.Paint(Graphics, PaintOptions, Options, Clipping, CurrentCave, CurrentBranch)
        End Sub
        ...
        'Public Function CreateGenericPen(ByVal Cave As String, ByVal Branch As String) As cItemFreeHandLine
        '    Dim oItem As cItemFreeHandLine = MyBase.CreateItem(cIItem.cItemTypeEnum.FreeHandLine, cIItem.cItemCategoryEnum.Border)
