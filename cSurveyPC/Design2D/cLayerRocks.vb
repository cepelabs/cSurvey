...
Namespace cSurvey.Design.Layers
    Public Class cLayerRocks
        ...
        Public Function CreateRockFromClipart(ByVal Cave As String, ByVal Branch As String, ByVal Data As Object, ByVal DataFormat As cItemClipart.cItemClipartDataFormatEnum) As cItemClipart
        ...
        Public Function CreateConcretionFromClipart(ByVal Cave As String, ByVal Branch As String, ByVal Data As Object, ByVal DataFormat As cItemClipart.cItemClipartDataFormatEnum) As cItemClipart
