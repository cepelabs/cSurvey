...
Public Class cDesignCenterlineControl
    Public Shadows Sub Rebind(Design As cIDesign, Options As cOptions)
        ...
        chkDesignPlotShowSegmentSurface.Checked = (MyBase.Options.DrawSegmentsOptions And cOptionsDesign.DrawSegmentsOptionsEnum.Surface) = cOptionsDesign.DrawSegmentsOptionsEnum.Surface
        chkDesignPlotShowSegmentDuplicate.Enabled = MyBase.Options.DrawSegments
        chkDesignPlotShowSegmentDuplicate.Checked = (MyBase.Options.DrawSegmentsOptions And cOptionsDesign.DrawSegmentsOptionsEnum.Duplicate) = cOptionsDesign.DrawSegmentsOptionsEnum.Duplicate
        ...
        chkDesignPlotShowSplayMode.Checked = MyBase.Options.ShowSplayMode = cOptionsDesign.ShowSplayModeEnum.All
    ...
    Private Sub pRefreshSize()
        Dim bChecked As Boolean = chkDesignPlot.Checked
        If bChecked Then
            Height = 460 * Me.CurrentAutoScaleDimensions.Height / 96.0F
        Else
    ...
    Private Sub chkDesignPlotShowSplayMode_CheckedChanged(sender As Object, e As EventArgs) Handles chkDesignPlotShowSplayMode.CheckedChanged
        If Not DisabledObjectProperty() Then
            MyBase.Options.ShowSplayMode = If(chkDesignPlotShowSplayMode.Checked, cOptionsDesign.ShowSplayModeEnum.All, cOptionsDesign.ShowSplayModeEnum.OnlyInRange)
    ...
    Private Sub chkDesignPlotShowSurface_CheckedChanged(sender As Object, e As EventArgs) Handles chkDesignPlotShowSegmentSurface.CheckedChanged
        If Not DisabledObjectProperty() Then
            If chkDesignPlotShowSegmentSurface.Checked Then
                MyBase.Options.DrawSegmentsOptions = MyBase.Options.DrawSegmentsOptions Or cOptionsDesign.DrawSegmentsOptionsEnum.Surface
            Else
                MyBase.Options.DrawSegmentsOptions = MyBase.Options.DrawSegmentsOptions And Not cOptionsDesign.DrawSegmentsOptionsEnum.Surface
            End If
    ...
    Private Sub chkDesignPlotShowSegmentDuplicate_CheckedChanged(sender As Object, e As EventArgs) Handles chkDesignPlotShowSegmentDuplicate.CheckedChanged
        If Not DisabledObjectProperty() Then
            If chkDesignPlotShowSegmentDuplicate.Checked Then
                MyBase.Options.DrawSegmentsOptions = MyBase.Options.DrawSegmentsOptions Or cOptionsDesign.DrawSegmentsOptionsEnum.Duplicate
            Else
                MyBase.Options.DrawSegmentsOptions = MyBase.Options.DrawSegmentsOptions And Not cOptionsDesign.DrawSegmentsOptionsEnum.Duplicate
            End If
    ...
    Private Sub grdViewHighlights_CustomUnboundColumnData(sender As Object, e As CustomColumnDataEventArgs) Handles grdViewHighlights.CustomUnboundColumnData
        ...
        Else
            If e.Column Is colHLSelected Then
                If MyBase.Options.HighlightsOptions.Set(DirectCast(e.Row, Properties.cHighlightsDetail), e.Value) Then
                    Call MyBase.DrawInvalidate()
                End If
            End If
        End If
    ...
    Private Sub grdHighlights_Resize(sender As Object, e As EventArgs) Handles grdHighlights.Resize
        grdHighlights.Width = grdHighlights.Parent.Width - 130 * Me.CurrentAutoScaleDimensions.Height / 96.0F
    End Sub
