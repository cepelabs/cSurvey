...
Friend Class cDockText
    ...
    Private Sub txtText_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles txtText.MouseDown
        If Not My.Computer.Keyboard.CtrlKeyDown Then
            Try
                ...
                If sText <> "" Then
                    oDragItem = New OnItemEventArgs(oBag, sText, cboPropTextStyle.EditValue, cboPropTextSize.SelectedIndex)
    ...
    Private Sub pItemCreate()
        Try
            Dim sText As String = txtText.Text
            Dim iType As cItemFont.FontTypeEnum = cboPropTextStyle.EditValue
    ...
    Public Sub SetOptions(PaintOptions As cOptions)
        Call cboPropTextStyle.Rebind(PaintOptions)

        cboPropTextStyle.EditValue = cItemFont.FontTypeEnum.Generic
