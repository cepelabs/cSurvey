...
Partial Class cItemCompassPropertyControl
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblCompassMode = New DevExpress.XtraEditors.LabelControl()
        Me.cboCompassMode = New System.Windows.Forms.ComboBox()
        Me.cboCompassNorth = New System.Windows.Forms.ComboBox()
        Me.lblCompassNorth = New DevExpress.XtraEditors.LabelControl()
        Me.lblCompassYear = New DevExpress.XtraEditors.LabelControl()
        ...
        Me.picCompassClipartImage.Properties.NullText = resources.GetString("picCompassClipartImage.Properties.NullText")
        Me.picCompassClipartImage.Properties.ReadOnly = True
        Me.picCompassClipartImage.Properties.ShowEditMenuItem = DevExpress.Utils.DefaultBoolean.[False]
    ...
    Friend WithEvents lblCompassMode As DevExpress.XtraEditors.LabelControl
    Friend WithEvents cboCompassMode As ComboBox
    Friend WithEvents cboCompassNorth As ComboBox
    Friend WithEvents lblCompassNorth As DevExpress.XtraEditors.LabelControl
    Friend WithEvents lblCompassYear As DevExpress.XtraEditors.LabelControl
