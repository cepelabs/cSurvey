...
Public Class cBrushStyleDropDown
    ...
    Private Sub pAppendItem(Brush As cCustomBrush, Optional FromFile As Boolean = False)
        ...
        If Brush.Type = cBrush.BrushTypeEnum.User Then
            ...
            bUser = True
        Else
            oSVGImage = DevExpress.Utils.Svg.SvgImage.FromFile(IO.Path.Combine(modMain.GetApplicationPath, "Objects\brushes\" & Brush.Type.ToString & ".svg")) '<image=#warning;size=16,16>
            bUser = False
        End If
