...
Partial Class cLinkedSurveySelectorControl
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnSelectAll.ImageOptions.ImageIndex = CType(resources.GetObject("btnSelectAll.ImageOptions.ImageIndex"), Integer)
        Me.btnSelectAll.ImageOptions.LargeImageIndex = CType(resources.GetObject("btnSelectAll.ImageOptions.LargeImageIndex"), Integer)
        Me.btnSelectAll.ImageOptions.SvgImage = CType(resources.GetObject("btnSelectAll.ImageOptions.SvgImage"), DevExpress.Utils.Svg.SvgImage)
        ...
        Me.btnDeselectAll.ImageOptions.ImageIndex = CType(resources.GetObject("btnDeselectAll.ImageOptions.ImageIndex"), Integer)
        Me.btnDeselectAll.ImageOptions.LargeImageIndex = CType(resources.GetObject("btnDeselectAll.ImageOptions.LargeImageIndex"), Integer)
        Me.btnDeselectAll.ImageOptions.SvgImage = CType(resources.GetObject("btnDeselectAll.ImageOptions.SvgImage"), DevExpress.Utils.Svg.SvgImage)
        ...
        Me.btnRefresh.Id = 2
        Me.btnRefresh.ImageOptions.ImageIndex = CType(resources.GetObject("btnRefresh.ImageOptions.ImageIndex"), Integer)
        Me.btnRefresh.ImageOptions.LargeImageIndex = CType(resources.GetObject("btnRefresh.ImageOptions.LargeImageIndex"), Integer)
