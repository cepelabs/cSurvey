...
Namespace cSurvey.Design
    Public Class cDesignInfoBox
        ...
        Public Overrides Sub Render(ByVal Graphics As Graphics, ByVal PaintOptions As cOptions)
            ...
            With oCache
                If .Invalidated Then
                    ...
                    Dim oPreviewOptions As cOptions = PaintOptions
                    Dim sBoxWidth As Single
                    Dim sBoxHeight As Single
                    ...
                    Dim oBrush As SolidBrush = New SolidBrush(oPreviewOptions.InfoBoxOptions.TextFont.Color)
                    ...
                    Dim oTitleBrush1 As SolidBrush = New SolidBrush(oPreviewOptions.InfoBoxOptions.IDFont.Color)
                    Dim oTitleFont2 As Font = oPreviewOptions.InfoBoxOptions.TitleFont.GetFont(PaintOptions)
                    Dim oTitleBrush2 As SolidBrush = New SolidBrush(oPreviewOptions.InfoBoxOptions.TitleFont.Color)
                    ...
                    End If
                    Call oBrush.Dispose()
                    Call oTitleSF.Dispose()
                    Call oTitleBrush1.Dispose()
                    Call oTitleBrush2.Dispose()
