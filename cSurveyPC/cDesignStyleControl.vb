...
Public Class cDesignStyleControl
    ...
    Public Overloads ReadOnly Property Options As cOptionsDesign
        Get
    ...
    Public Overrides Sub Rebind(Design As cIDesign, Options As cOptions)
        ...
        chkDesignStyle0.Checked = Me.Options.DesignStyle = cOptions.DesignStyleEnum.Design
        chkDesignStyle1.Checked = Me.Options.DesignStyle = cOptions.DesignStyleEnum.Areas
        chkDesignStyle2.Checked = Me.Options.DesignStyle = cOptions.DesignStyleEnum.Combined

        pnlDesignCombineColorMode.Enabled = (Me.Options.DesignStyle = cOptions.DesignStyleEnum.Areas Or Me.Options.DesignStyle = cOptions.DesignStyleEnum.Combined)
