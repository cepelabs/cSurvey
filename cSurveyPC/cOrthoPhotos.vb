...
Namespace cSurvey.Surface
    Public Class cOrthoPhotos
        ...
        'Private Sub oOrthophoto_ondefaultset(Sender As cOrthoPhoto, e As cOrthoPhoto.cDefaultArgs)
        '    If e.ID = "" Then
        '        oDefault = Nothing
        '    Else
        '        oDefault = Sender
        ...
        'Private Sub oOrthophoto_ondefaultGet(Sender As cOrthoPhoto, e As cOrthoPhoto.cDefaultArgs)
        '    If Not oDefault Is Nothing Then
        '        e.ID = oDefault.ID
        '    End If
        'End Sub

        Private Sub oOrthophoto_onchange(sender As cISurfaceItem, e As EventArgs)
        ...
        Friend Sub CopyFrom(OrthoPhotos As cOrthoPhotos)
            ...
            For Each oItem In OrthoPhotos.oItems
                ...
                Call oItems.Add(oOrthophoto)
            Next
            Call oOrthophoto_onchange(Nothing, EventArgs.Empty)
        End Sub
