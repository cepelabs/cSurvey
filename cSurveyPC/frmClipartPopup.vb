...
Friend Class frmClipartPopup
    ...
    Private Sub pItemRemove()
        ...
        If Not oGrid Is Nothing Then
            Dim oItem As cGalleryItem = pGetCurrentItem()
            If Not oItem Is Nothing Then
                If MsgBox(modMain.GetLocalizedString("clipartgallery.warning1"), MsgBoxStyle.YesNo Or MsgBoxStyle.Question, modMain.GetLocalizedString("clipartgallery.warningtitle")) = vbYes Then
    ...
    'Public Function IsGallery(ByVal Grid As DevExpress.XtraGrid.GridControl) As Boolean
    '    For Each oItem As NavigationBarItem In tabGallery.Items
