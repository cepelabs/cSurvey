...
Partial Class frmImportGenericData
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblDataSeparator = New System.Windows.Forms.Label()
        ...
        Me.cboSeparator.Items.AddRange(New Object() {resources.GetString("cboSeparator.Items"), resources.GetString("cboSeparator.Items1"), resources.GetString("cboSeparator.Items2"), resources.GetString("cboSeparator.Items3"), resources.GetString("cboSeparator.Items4")})
    ...
    Friend WithEvents lblDataSeparator As System.Windows.Forms.Label
