...
Friend Class frmLevels
    ...
    Private Sub pSurveyLoadTreeLayers()
        ...
        Else
            ...
            '    tvLayers.Roots = Nothing
            '    Call tvLayers.BuildList(True)
            '    tvLayers.EndUpdate()
            '    tvLayers.Visible = False
            'Else
            '    Call tvLayers.BeginUpdate()
            '    If Not tvLayers.Roots Is oDesign.Layers Then
            '        tvLayers.Roots = oDesign.Layers
            '    End If
            '    Call tvLayers.BuildList(True)
            '    tvLayers.EndUpdate()
            '    tvLayers.Visible = True
            'End If
        End If
    End Sub
    ...
    Private Sub TreeList1_CustomUnboundColumnData(sender As Object, e As TreeListCustomColumnDataEventArgs) Handles tvLayers.CustomUnboundColumnData
        If e.IsGetData Then
    ...
    Private Sub TreeList1_NodeCellStyle(sender As Object, e As GetCustomNodeCellStyleEventArgs) Handles tvLayers.NodeCellStyle
    ...
    Private Sub TreeList1_GetSelectImage(sender As Object, e As GetSelectImageEventArgs) Handles tvLayers.GetSelectImage
        Dim oElement As Object = tvLayers.GetRow(e.Node.Id)
    ...
    Private Sub btnInvertFilter_CheckedChanged(sender As Object, e As XtraBars.ItemClickEventArgs) Handles btnInvertFilter.CheckedChanged
        oDesignTools.Filter.Reversed = btnInvertFilter.Checked
    End Sub
