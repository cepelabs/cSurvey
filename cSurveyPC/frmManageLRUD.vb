...
Public Class frmManageLRUD
    ...
    Private Sub pSettingsSave()
        Try
            ...
            Call oReg.SetValue("editor.managelrud.option", IIf(RadioButton1.Checked, 0, IIf(RadioButton2.Checked, 1, IIf(RadioButton3.Checked, 2, IIf(RadioButton4.Checked, 4, "")))))
            Call oReg.SetValue("editor.managelrud.option0", IIf(RadioButton1a.Checked, "0", IIf(RadioButton1b.Checked, "1", "")))
            Call oReg.SetValue("editor.managelrud.deleteafterrestore", IIf(chkRestoreDeleteBackupAfterRestore.Checked, "1", "0"))
            Call oReg.SetValue("editor.managelrud.backup", IIf(chkBackup.Checked, "1", "0"))
            Call oReg.SetValue("editor.managelrud.option1onlycutsplay", IIf(chkMode2OnlyCutSplay.Checked, "1", "0"))
            ...
            Call oReg.SetValue("editor.managelrud.markascalculated", IIf(chkMarkAsCalculated.Checked, "1", "0"))

            Call oReg.SetValue("editor.managelrud.shotwithlrud", IIf(chkShotWithLRUD.Checked, "1", "0"))
            Call oReg.SetValue("editor.managelrud.shotwithcalculatedlrud", IIf(chkShotWithCalculatedLRUD.Checked, "1", "0"))
            Call oReg.SetValue("editor.managelrud.shotwithoutlrud", IIf(chkShotWithoutLRUD.Checked, "1", "0"))
            Call oReg.Close()
            Call oReg.Dispose()
        Catch
        End Try
