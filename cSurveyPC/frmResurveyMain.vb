...
Friend Class frmResurveyMain
    ...
    Private Sub pQATRestore()
        ...
        Call RibbonControl.Toolbar.ItemLinks.Add(btnOptions, True)
        Call RibbonControl.Toolbar.ItemLinks.Add(btnLoadImage, True)
        Call RibbonControl.Toolbar.ItemLinks.Add(btnCalculate, True)
    ...
    Private Sub btnQATRestore_ItemClick(sender As Object, e As ItemClickEventArgs) Handles btnQATRestore.ItemClick
        If cSurvey.UIHelpers.Dialogs.Msgbox(GetLocalizedString("main.warning34"), MsgBoxStyle.YesNo Or MsgBoxStyle.Exclamation, GetLocalizedString("main.warningtitle")) = vbYes Then
            Call pQATRestore()
        End If
    End Sub
