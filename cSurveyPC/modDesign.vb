...
#Region "GetLRUDFromDesign"
    ...
    Friend Class cLRFromDesignCache
        ...
        Public Sub New(Survey As cSurvey.cSurvey, Plan As cDesignPlan, PaintOptions As cOptions, Optional MaxSize As Integer = 1000)
            oSurvey = Survey
...
#End Region
    ...
    Friend Class cUDFromDesignCache
        ...
        Public Sub New(Survey As cSurvey.cSurvey, Profile As cDesignProfile, PaintOptions As cOptions, Optional MaxSize As Integer = 1000)
            oSurvey = Survey
            oPaintOptions = PaintOptions
